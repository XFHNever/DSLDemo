...
import com.stubhub.never.statemachine.core.*;

/**
 * Created by fuxie on 2014/7/18  13:23.
 */
public class GrantSample {
    ...
    public GrantSample() {
        ...
        controller = new Controller(idle, machine, commandChannel);
    }
